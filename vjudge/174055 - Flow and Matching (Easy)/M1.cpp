...
//        int Y = y + dy[i];
////        debug("v",X,Y)
//        if(X>=0 && Y>=0 && X<5 && Y<c && vis[X][Y]==0 && st[X][Y]!='@')
//        {
//            mcmf::addEdge(MAP[x][y], MAP[X][Y], 1, (int)(st[X][Y]-'0'));
//            dfs(X,Y,c);
//        }
//    }
//}
        ...
        FOR(i,0,4)
        {
            FOR(j,0,c-1)
            {
                FOR(k,0,3)
                {
                    ...
                    {
                        mcmf::addEdge(out[i][j], in[x][y], INF, (int)(st[x][y]-'0'));
                    }
//                    if(x >=0 && y>=0 && x<5 && y<c && st[x][y]=='@')
//                    {
...
//            debug(i,c-1,in,MAP[i][c-1])
            mcmf::addEdge(out[i][c-1], sink, INF, 0);
