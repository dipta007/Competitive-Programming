...
//    ios_base::sync_with_stdio(0);cin.tie(0);
    ...
    FOR(ci,1,t)
    {
        ...
        FOR(i,0,n) FOR(j,0,n) adjMatrix[i][j] = (i==j) ? 0 : 10000;

//        debug(adjMatrix[0][0], adjMatrix[0][1]);
        FOR(i,1,m)
        {
            int x,y;
            getII(x,y);
        ...
        int c[n],d[n];
        FOR(i,0,n-1) getI(c[i]);
        FOR(i,1,n) getI(d[i-1]);
        ...
        FOR(i,0,(int)a.size()-1)
        {
            ...
            {
                mcmf::addEdge(i+1, a.size()+j+1, 1, adjMatrix[a[i]][b[j]]);
            }
        }
        FOR(i,0,(int)a.size()-1) mcmf::addEdge(0,i+1,1, 0);
        FOR(i,0,(int)b.size()-1) mcmf::addEdge(i+a.size()+1,n+1,1, 0);
