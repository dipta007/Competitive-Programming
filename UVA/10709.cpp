...
int main() {
    ...
    while(cin >> p1.x >> p1.y)
    {
        ...
        if(s1 == "L" && s2 == "L")
        {
            ...
            {
                double res = INF;
                res = min(res, l1.dispointtoline(p3));
                res = min(res, l1.dispointtoline(p4));
                res = min(res, l2.dispointtoline(p1));
                res = min(res, l2.dispointtoline(p2));
                cout << res << endl;
            }
        ...
        {
            if(l1.segmentIntersection(l2)) cout << "0.00000" << endl;
            else
            {
                double res = INF;
                res = min(res, l1.dispointtoseg(p3));
                res = min(res, l1.dispointtoseg(p4));
                res = min(res, l2.dispointtoseg(p1));
                res = min(res, l2.dispointtoseg(p2));
                cout << res << endl;
            }
        }
        else if(s1 == "LS")
        {
            if(l1.lineCrossSeg(l2) == false)
            {
                double res = INF;
                res = min(res, l2.dispointtoline(l1.a));
                res = min(res, l2.dispointtoline(l1.b));
                cout << res << endl;
            }
            else cout << "0.00000" << endl;
        }
        ...
        {
//            trace(l2.lineCrossSeg(l1));
            if(l2.lineCrossSeg(l1) == false)
            {
                double res = INF;
                res = min(res, l1.dispointtoline(l2.a));
                res = min(res, l1.dispointtoline(l2.b));
                cout << res << endl;
            }
            else cout << "0.00000" << endl;
        }
