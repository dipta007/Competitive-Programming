   ...
   // ios_base::sync_with_stdio(0);cin.tie(0);
    ...
    FOR(ci,1,t)
    {
        ...
        while(low <= high)
        {
            ...
            mf::init(mark[MP(0,0)], mark[MP(n,d)], in+4);
            FOR(i,0,m-1)
            {
                if(vn[i].c <= mid)
                {
                    pii up = MP(vn[i].u, vn[i].day);
                    pii vp = MP(vn[i].v, vn[i].day+1);

                    mf::addEdge(mark[up], mark[vp], vn[i].p, 0);
                }
            }
            ...
            FOR(i,1,n)
            {
                FOR(j,0,d-1)
                {
                    ...
                    mf::addEdge(mark[u], mark[v], INF, 0);
                }
            }
            ...
            FOR(i,0,n-1)
            {
                ...
                mf::addEdge(mark[u], mark[v], z[i], 0);
            }

//            debug(mid, mf::dinic(), tot)
            if(mf::dinic() == tot)
            {
                high = mid - 1;
                ans = mid;
