...
//        debug("**")
        ...
        while(1)
        {
            ...
            else if(st == "mysql -u root -p People")
            {
                if(db)
                {
                    cout << "I can't write queries. So Shakib is a bad boy." << endl;
                    continue;
                }
                db = 1;
            }
            ...
            {
                if(db==0 || tb==1) cout << "I can't write queries. So Shakib is a bad boy." << endl;
                else tb = 1;
            }
            else if(st == "select * from people")
            {
                if(db==0 || tb==0) cout << "I can't write queries. So Shakib is a bad boy." << endl;
                else gen();
            }
            else if(st.substr(0,9) == "order by ")
            {
                if(db==0 || tb==0)
                {
                    cout << "I can't write queries. So Shakib is a bad boy." << endl;
                ...
                if(tmp == "asc")
                {
                    if(flg==0) cout << "I can't write queries. So Shakib is a bad boy." << endl;
                ...
                {
                    if(flg==0) cout << "I can't write queries. So Shakib is a bad boy." << endl;
                    else if(flg == 1) sort(ALLR(vd),comp1);
                    else if(flg == 2) sort(ALLR(vd),comp2);
                    else if(flg == 3) sort(ALLR(vd),comp3);
                    else if(flg == 4) sort(ALLR(vd),comp4);
                    else if(flg == 5) sort(ALLR(vd),comp5);
                }
                else cout << "I can't write queries. So Shakib is a bad boy." << endl;
            }
            else cout << "I can't write queries. So Shakib is a bad boy." << endl;
        }
    }
