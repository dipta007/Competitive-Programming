...
int main() {
    ...
    FOR(ci,1,t)
    {
        ...
        int cnt = 3;
        if(c[0].relationcircle(c[1]) == 3) cnt++;
        debug(cnt);
        if(c[0].relationcircle(c[2]) == 3) cnt++;
        debug(cnt);
        if(c[1].relationcircle(c[2]) == 3) cnt++;
        debug(cnt);
        if(c[0].relationcircle(c[1]) == 3 && c[0].relationcircle(c[2]) == 3 && c[1].relationcircle(c[2]) == 3) cnt++;
//        if(check(0,2)) cnt++;
//        if(check(1,2)) cnt++;
//        if(check(0,1) && check(0,2)) cnt++;
