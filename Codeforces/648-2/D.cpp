...
void bfs(int x, int y) {
    ...
    while (!q.empty()) {
        ...
        FOR(i,0,3) {
            ...
            if (vx >= 0 && vy >= 0 && vx < n && vy < m && vis[vx][vy] == 0 && mat[vx][vy] != 2) {
                q.push(vx);
                q.push(vy);
                vis[vx][vy] = 1;
            }
...
void block(int x, int y) {
    if (x-1 >= 0 && mat[x-1][y] == 0) mat[x-1][y] = 2;
    if (x+1 < n && mat[x+1][y] == 0) mat[x+1][y] = 2;
    if (y+1 < m && mat[x][y+1] == 0) mat[x][y+1] = 2;
    if (y-1 >= 0 && mat[x][y-1] == 0) mat[x][y-1] = 2;
}
