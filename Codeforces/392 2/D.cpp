...
bigint call(int in,ull pwr)
{
//    if(bigmod(basee,pwr,INF)>=1000000000000000000LL) return 2000000000000000000LL;
    //debug(in)
    if(in<0)
    {
        return 0;
