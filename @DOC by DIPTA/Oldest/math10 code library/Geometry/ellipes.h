...
struct ellipes{
    db a,b,f,e; //a is half of major axis , b is half of minor axis ,f is focus , e is  eccentricity
    point center,f1,f2;

    ellipes(db a,db b):a(a),b(b){ // given by a,b
        center = point(0,0);
        f = sqrt(a*a + b*b);
        e = f/a;
        f1 = point(-f,0);
   ...
   /* ellipes(db mejor,db minor){ //given by mejor & minor axis
