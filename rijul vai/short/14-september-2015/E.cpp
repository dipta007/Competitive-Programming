...
//******************DELETE****************
//
//int n,arr[1004],total;
//bool dp[1002][1000002],visited[1002][1000002];
//
...
//    {
//        arr[samne]--;
//        s1=call(in+1,sum+samne);
//    }
//    if(arr[pisone])
//    {
//        arr[pisone]--;
//        s2=call(in+1,sum+pisone);
//    }
//    return dp[in][sum]=s1|s2;
//}
...
int main() {
    ...
    for(int ci=1;ci<=t;ci++)
    {
        ...
        for(int i=0;i<n;i++)
        {
            int pisone=i;
            int samne=n-i-1;
            if(arr[pisone]) arr[pisone]--;
            else if(arr[samne]) arr[samne]--;
            else
            {
                flg=0;
                break;
