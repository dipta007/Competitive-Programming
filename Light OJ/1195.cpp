...
int main() {
    ...
    FOR(ci,1,t)
    {
        ...
        int tot = a.size();
        adj1.assign(tot+4, vi());
        adj2.assign(tot+4, vi());
        int node1 = 1;
        int now = 0;
        FOR(i,0,tot-1)
        {
        ...
        if(f) cout << "Case " << ci << ": Same" << endl;
        else cout << "Case " << ci << ": Different" << endl;
    }
