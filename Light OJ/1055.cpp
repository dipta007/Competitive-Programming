...
//        cout << x1 <<" " <<y1 <<" " <<x2 <<" " <<y2 <<" " <<x3 <<" " <<y3 <<" dist " <<dis[x1][y1][x2][y2][x3][y3] <<endl;
...
//            cout << x1 <<" " <<y1 <<" " <<x2 <<" " <<y2 <<" " <<x3 <<" " <<y3 <<" " <<endl;
        ...
        for(int i=0; i<4; i++)
        {
            ...
            if(flg)
            {
                ...
                while(((rx1==rx2 && ry1==ry2) || (rx2==rx3 && ry2==ry3) || (rx1==rx3 && ry1==ry3)) && (c1 || c2 || c3))
                {
                    //cout << c1 << c2 << c3 <<endl;
                    if(rx1==rx2 && ry1==ry2)
                    {
